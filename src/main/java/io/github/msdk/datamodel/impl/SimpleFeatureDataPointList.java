 ...
 */
class SimpleFeatureDataPointList implements FeatureDataPointList {
     ...
     */
    SimpleFeatureDataPointList(@Nonnull Integer initialCapacity) {
     ...
     */
    SimpleFeatureDataPointList(@Nonnull double mzBuffer[],
    ...
    @Override
    public void setBuffers(ChromatographyInfo[] rtBuffer,
            float[] intensityBuffer, int newSize) {
        // TODO Auto-generated method stub
    ...
    @Override
    public void copyFrom(FeatureDataPointList list) {
        // TODO Auto-generated method stub
        
    }

    @Override
    public FeatureDataPointList selectDataPoints(Range<Float> rtRange,
