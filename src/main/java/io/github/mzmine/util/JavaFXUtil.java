...
public class JavaFXUtil {
  ...
  /**
   * Convenience method for searching above comp in the component hierarchy and returns the first
  ...
  public static Color convertColorToJavaFX(java.awt.Color col) {
    return Color.rgb(col.getRed(), col.getGreen(), col.getBlue(), (double) col.getAlpha() / 255.0);
  }
