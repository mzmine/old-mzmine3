...
public class NumOfThreadsEditor extends HBox implements ParameterEditor<NumOfThreadsValue> {
  ...
  public NumOfThreadsValue getValue() {
    Boolean automatic = (optionCombo.getSelectionModel().getSelectedIndex() == 0);
