...
public class RTToleranceParameter extends AbstractParameter<RTTolerance> {
  ...
  public RTToleranceParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category) {
    this(name, description, category, null, null);
  }

  public RTToleranceParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category, RTTolerance defaultValue) {
    this(name, description, category, null, defaultValue);
  }

  public RTToleranceParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category, @Nullable ParameterValidator<RTTolerance> validator) {
  ...
  public @Nonnull RTToleranceParameter clone() {
    RTToleranceParameter copy = new RTToleranceParameter(getName(), getDescription(), getCategory(),
