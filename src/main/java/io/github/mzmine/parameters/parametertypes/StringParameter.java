...
public class StringParameter extends AbstractParameter<String> {
  ...
  public StringParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category, @Nullable ParameterValidator<String> validator) {
  ...
  public StringParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category, @Nullable ParameterValidator<String> validator,
      @Nullable String defaultValue, @Nullable EventHandler<ActionEvent> autoSetAction) {
  ...
  public @Nonnull StringParameter clone() {
    StringParameter copy = new StringParameter(getName(), getDescription(), getCategory(),
        getValidator(), getValue(), autoSetAction);
    return copy;
  }
