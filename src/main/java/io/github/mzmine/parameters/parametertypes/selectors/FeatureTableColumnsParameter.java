...
public class FeatureTableColumnsParameter extends AbstractParameter<FeatureTableColumnsSelection> {

  private static final @Nonnull String NAME = "Column names";
  private static final @Nonnull String DESCRIPTION =
      "Feature table column names to include. You can use wildcards (*), for example *area.";
  private static final @Nonnull String CATEGORY = "Input";

  public FeatureTableColumnsParameter() {
    super(NAME, DESCRIPTION, CATEGORY, FeatureTableColumnsEditor.class, null);
  }
