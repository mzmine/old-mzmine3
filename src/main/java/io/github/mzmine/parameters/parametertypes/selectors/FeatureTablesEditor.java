...
public class FeatureTablesEditor extends HBox
        implements ParameterEditor<FeatureTablesSelection> {
    ...
    public FeatureTablesEditor(PropertySheet.Item parameter) {
        ...
        typeCombo.setOnAction(e -> {
            FeatureTablesSelectionType type = typeCombo.getSelectionModel()
                    .getSelectedItem();
    ...
    public FeatureTablesSelection getValue() {
        FeatureTablesSelectionType selectionType = typeCombo.getSelectionModel()
                .getSelectedItem();
