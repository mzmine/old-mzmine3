...
public class FeatureTablesParameter extends AbstractParameter<FeatureTablesSelection> {

  private static final @Nonnull String NAME = "Feature tables";
  private static final @Nonnull String DESCRIPTION =
      "Feature tables that this module will take as its input.";
  ...
  public void loadValueFromXML(@Nonnull Element xmlElement) {
    ...
    List<FeatureTable> currentDataFiles = MZmineCore.getCurrentProject().getFeatureTables();
    ...
    if (Strings.isNullOrEmpty(attrValue))
      ...
      selectionType = FeatureTablesSelectionType.valueOf(xmlElement.getAttribute("type"));
    ...
    setValue(new FeatureTablesSelection(selectionType, specificFiles, namePattern));
  }
  ...
  public void switchType(FeatureTablesSelectionType newType) {
    ...
    if (curValue == null)
      ...
      newValue = new FeatureTablesSelection(newType, curValue.getSpecificFeatureTables(),
