...
public class IntegerRangeParameter extends AbstractParameter<Range<Integer>> {
    ...
    public IntegerRangeParameter(@Nonnull String name,
    ...
    public IntegerRangeParameter(@Nonnull String name,
            @Nonnull String description, @Nonnull String category,
            @Nullable ParameterValidator<Range<Integer>> validator) {
    ...
    public @Nonnull IntegerRangeParameter clone() {
        IntegerRangeParameter copy = new IntegerRangeParameter(getName(),
