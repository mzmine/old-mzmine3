...
public class ToggleParameter<ValueType> extends AbstractParameter<ValueType> {
    ...
    public ToggleParameter(@Nonnull String name, @Nonnull String description,
            @Nonnull String category, List<ValueType> choices,
            String defaultValue) {
        this(name, description, category, null, choices, defaultValue);
    }

    public ToggleParameter(@Nonnull String name, @Nonnull String description,
            @Nonnull String category,
            @Nullable ParameterValidator<ValueType> validator,
            List<ValueType> choices) {
        this(name, description, category, validator, choices, null);
    }
    ...
    public ToggleParameter(@Nonnull String name, @Nonnull String description,
            @Nonnull String category,
            @Nullable ParameterValidator<ValueType> validator,
            List<ValueType> choices, @Nullable String defaultValue) {
