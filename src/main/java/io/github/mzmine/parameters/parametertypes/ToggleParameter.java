...
public class ToggleParameter<ValueType> extends AbstractParameter<ValueType> {
  ...
  public ToggleParameter(@Nonnull String name, @Nonnull String description,
      @Nonnull String category, List<ValueType> toggleValues, String defaultValue) {
  ...
  public ToggleParameter(@Nonnull String name, @Nonnull String description,
    ...
    super(name, description, category, (Class) ToggleEditor.class, validator);
  ...
  public @Nonnull ToggleParameter<ValueType> clone() {
    ToggleParameter<ValueType> copy = new ToggleParameter<ValueType>(getName(), getDescription(),
        getCategory(), getValidator(), toggleValues);
