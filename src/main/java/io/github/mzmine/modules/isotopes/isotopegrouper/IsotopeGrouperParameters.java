...
public class IsotopeGrouperParameters extends ParameterSet {
  ...
  public static final IntegerParameter maximumCharge = new IntegerParameter("Maximum charge",
      "Maximum charge to consider for detecting the isotope patterns.", "Algorithm Parameters",
      ParameterValidator.createNonEmptyValidator(), 2);

  public static final ComboParameter<RepresentativeIsotope> representativeIsotope =
      new ComboParameter<>("Representative isotope",
          ...
          "Algorithm Parameters", Arrays.asList(RepresentativeIsotope.values()),
  ...
  public static final StringParameter nameSuffix = new StringParameter("Name suffix",
      "Suffix to be added to the feature table name.", "Output", " deisotoped");
  ...
  public IsotopeGrouperParameters() {
    super(featureTables, mzTolerance, rtTolerance, maximumCharge, representativeIsotope,
        monotonicShape, nameSuffix, removeOldTable);
  }
