...
public class SpectrumParserPlotParameters extends ParameterSet {
    ...
    public static final TextAreaParameter spectrumText = new TextAreaParameter(
            "Spectrum data",
            ...
            "Input", ParameterValidator.createNonEmptyValidator(),
            Arrays.asList(filters));

    public static final ComboParameter<MsSpectrumType> spectrumType = new ComboParameter<>(
            "Spectrum type", "Spectrum type, centroid or profile?", "Input",
            ParameterValidator.createNonEmptyValidator(),
            Arrays.asList(new MsSpectrumType[] { MsSpectrumType.CENTROIDED,
