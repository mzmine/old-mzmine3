...
public class ChromatogramPlotParameters extends ParameterSet {
  ...
  public static final ComboParameter<ChromatogramPlotType> plotType =
      new ComboParameter<>("Plot type", "Type of Y value calculation (TIC = sum, base peak = max)",
          "Category", Arrays.asList(ChromatogramPlotType.values()), ChromatogramPlotType.BASEPEAK);
