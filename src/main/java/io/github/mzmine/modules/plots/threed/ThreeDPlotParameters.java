...
public class ThreeDPlotParameters extends ParameterSet {
  ...
  public static final DoubleRangeParameter mzRange =
      new DoubleRangeParameter("m/z range", "m/z range", "Data range");

  public static final IntegerParameter rtResolution =
      new IntegerParameter("Retention time resolution",
  ...
  public static final IntegerParameter mzResolution = new IntegerParameter("m/z resolution",
      "Number of data points on m/z axis", "Resolution", 500);

  /**
   * Create the parameter set.
   */
  public ThreeDPlotParameters() {
