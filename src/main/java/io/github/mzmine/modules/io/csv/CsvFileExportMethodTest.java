...
public class CsvFileExportMethodTest {
  ...
  public void CSV_Multi_Samples_Import() throws MSDKException {
    ...
    CsvFileExportMethod exporter = new CsvFileExportMethod(featureTable, tempFile, separator,
    ...
    try {
      lines = Files.asCharSource(tempFile, Charset.defaultCharset()).readLines();
