...
import io.github.mzmine.modules.io.csv.CsvFileImportMethod;
...
public class FeatureTableImportModule implements MZmineProcessingModule {
  ...
  private static final String MODULE_DESCRIPTION =
      "This module imports feature tables into the project.";
  ...
  public void runModule(@Nonnull MZmineProject project, @Nonnull ParameterSet parameters,
    ...
    final List<File> fileNames =
        parameters.getParameter(FeatureTableImportParameters.fileNames).getValue();
    final String removePrefix =
        parameters.getParameter(RawDataImportParameters.removePrefix).getValue();
    final String removeSuffix =
        parameters.getParameter(RawDataImportParameters.removeSuffix).getValue();
    ...
    for (File fileName : fileNames) {
      ...
      MSDKTask newTask =
          new MSDKTask("Importing feature table file", fileName.getName(), finalMethod);
