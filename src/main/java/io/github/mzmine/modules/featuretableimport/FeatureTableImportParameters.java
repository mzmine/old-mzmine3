...
public class FeatureTableImportParameters extends ParameterSet {
  ...
  private static final ExtensionFilter filters[] =
      new ExtensionFilter[] {new ExtensionFilter("All feature table files", "*.csv", "*.mzTab"),
          new ExtensionFilter("CSV files", "*.csv"), new ExtensionFilter("mzTab files", "*.mzTab"),
          new ExtensionFilter("All files", "*.*")};

  public static final FileNamesParameter fileNames =
      new FileNamesParameter("File names", "Add feature table files", "Input files",
          ParameterValidator.createNonEmptyValidator(), Arrays.asList(filters));

  @SuppressWarnings({"unchecked"})
  public static final StringParameter removePrefix = new StringParameter("Remove prefix",
      "Prefix to be removed from file names", "Prefixes", null, null, e -> {
  ...
  @SuppressWarnings({"unchecked"})
  public static final StringParameter removeSuffix = new StringParameter("Remove suffix",
      "Suffix to be removed from file names", "Prefixes", null, null, e -> {
        StringEditor editor = null;
        PropertySheet sheet = null;
        Node src = (Node) e.getSource();
        while (src != null) {
