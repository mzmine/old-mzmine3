...
public class ChromatogramBuilderParameters extends ParameterSet {
  ...
  public static final DoubleParameter noiseLevel =
      new DoubleParameter("Noise level", "Data points below this intensity will be ignored",
          "Algorithm Parameters", MZmineCore.getConfiguration().getIntensityFormat(),
          ParameterValidator.createNonEmptyValidator(), null);

  public static final DoubleParameter minDuration = new DoubleParameter("Min peak duration",
  ...
  public ChromatogramBuilderParameters() {
    super(rawDataFiles, mzTolerance, noiseLevel, minDuration, minHeight, nameSuffix);
  }
