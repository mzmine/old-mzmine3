...
import io.github.msdk.centroiding.WaveletCentroidingAlgorithm;
 ...
 * Wavelet centroiding
 */
public class WaveletCentroidingModule implements MZmineProcessingModule {

    private Logger logger = LoggerFactory.getLogger(this.getClass());

    private static final String MODULE_NAME = "Wavelet centroiding";
    private static final String MODULE_DESCRIPTION = "Wavelet centroiding";
    ...
    public void runModule(@Nonnull MZmineProject project,
        ...
        final Integer scaleLevel = parameters
                ...
                .getValue();
        final Double waveletWindow = parameters
                .getParameter(WaveletCentroidingParameters.waveletWindow)
                .getValue();
        ...
        for (RawDataFile rawDataFile : rawDataFiles.getMatchingRawDataFiles()) {
            ...
            MSDKTask newTask = new MSDKTask("Wavelet centroiding method",
    ...
    public @Nonnull Class<? extends ParameterSet> getParameterSetClass() {
        return WaveletCentroidingParameters.class;
    }
}
