...
JAVA_PARAMETERS="-showversion -classpath lib/\* -XX:+UseParallelGC -Xdock:name='MZmine 3' -Xdock:icon=icon/mzmine-icon.png -Djava.io.tmpdir=$TMP_FILE_DIRECTORY -Dapple.laf.useScreenMenuBar=true -Xms1024m -Xmx${HEAP_SIZE}m -Djava.library.path=${JRI_LIB_PATH}"
